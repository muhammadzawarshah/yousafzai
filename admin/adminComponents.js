...
class MyHeader extends HTMLElement {
    constructor() {
        ...
        this.innerHTML = `<header class="flex items-center bg-gradient-to-b from-gray-100 via-gray-300 to-gray-500 p-5 w-full">
                ...
                <div class="pl-4">
                    <h1 class="font-semibold text-base sm:text-2xl md:text-4xl text-red-700">YGO - Control Panel</h1>
    ...
    constructor() {
        ...
        this.innerHTML = `<nav class="sm:p-4 bg-gradient-to-b from-red-500 via-red-700 to-red-900 text-white relative sm:sticky top-[-1px] sm:z-50 flex items-center justify-end">
                <ul class="nav-links sm:flex sm:justify-evenly sm:items-center top-[-1000px] sm:static sm:z-auto absolute z-50 w-full left-0 bg-gradient-to-b from-red-400 via-red-600 to-red-800 sm:bg-none">
                    ...
                    <a href="/admin/index.html" class="hover:text-gray-400 duration-500">Dashboard</a>
                    </li>
                    <li class="sm:py-0 py-1 pl-4 sm:pl-0">
                        <a href="/admin/news-manager.html" class="hover:text-gray-400 duration-500">News Manager</a>
                    </li>
                    <li class="sm:py-0 py-1 pl-4 sm:pl-0">
                        <a href="/admin/executive-members-manager.html" class="hover:text-gray-400 duration-500">Executive Members</a>
                    </li>
                    <li class="sm:py-0 py-1 pl-4 sm:pl-0">
                        <a href="/admin/members-manager.html" class="hover:text-gray-400 duration-500">Membership</a>
                    </li>
                    
                    <li class="sm:py-0 py-1 pl-4 sm:pl-0">
                        <a href="/admin/contact-manager.html" class="hover:text-gray-400 duration-500">Contact Us</a>
                    </li>
                </ul>
                <div class="sm:hidden">
